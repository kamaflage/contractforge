...
const CACHE = 'contractforge-v3.1';
...
const ASSETS = [
  ...
  './icon-192.png',
  './icon-512.png',
  './contractforge_demo.mp4',
  './js/cf-state.js?v=3.1',
  './js/cf-wizard.js?v=3.1',
  './js/cf-scope.js?v=3.1',
  './js/cf-pricing.js?v=3.1',
  './js/cf-preview.js?v=3.1',
  './js/cf-save-load.js?v=3.1',
  './js/cf-ui.js?v=3.1',
